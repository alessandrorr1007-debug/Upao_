...
async function getCuenta(userId) {
    if (!userId) return [];
    ...
    try {
        ...
        await page.goto("https://ssb.upao.edu.pe/StudentSelfService/ssb/accountSummary#!/",
        ...
        console.error(`Error obteniendo cuenta para ${userId}:`, error.message);
        return [];
    } finally {
        await browser.close();
    }
